...
export const ChildFriendlyIcon: React.SFC<IIconProps> = props => {
  return (
    <FilledSVG xmlns="http://www.w3.org/2000/svg" width="24" height="24" {...props}>
...
export const FoodIcon: React.SFC<IIconProps> = props => {
  return (
    <FilledSVG xmlns="http://www.w3.org/2000/svg" width="24" height="24" {...props}>
...
export const TravelIcon: React.SFC<IIconProps> = props => {
  return (
    <FilledSVG xmlns="http://www.w3.org/2000/svg" width="24" height="24" {...props}>
